 ...
 * Copyright 2018 hav0k , Renesis Developers
 *
...
enum algos {
	...
	ALGO_X16R,
	ALGO_X16S,
	ALGO_RENESIS,	  // add Renesis Algo by hav0k //
	ALGO_X17,         /* X17 */
	ALGO_XEVAN,
	ALGO_YESCRYPT,
	ALGO_ZR5,
...
{
	printf("\n\n");
	printf("** " PACKAGE_NAME " " PACKAGE_VERSION " ported by hav0k, Renesis Project **\n");
	printf("Warning! Please use moderate mining threads not to overload your system\n");
	printf("Visit renesisgroup on github for latest updates \n");
	printf("Greetz to ocminer on #ccminer at irc.freenode.net \n");
	printf("Here we go ... \n");
}
